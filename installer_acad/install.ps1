...
<ApplicationPackage SchemaVersion="1.0" AutodeskProduct="AutoCAD" Name="LA批量打印" AppVersion="1.15.3" ProductCode="{7f2f2f2d-78d1-4df0-8c5d-acadba7c0011}" Description="AutoCAD批量打印插件">
